        ...
        <footer className="bg-brand-secondary dark:bg-slate-950 text-white py-20 overflow-hidden relative transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <p className="text-white/50 text-sm leading-relaxed max-w-xs">
                            Connecting neighborhoods, one video at a time. The social network built for India's vibrant communities.
                        </p>
                    ...
                    <div>
                        <h4 className="font-display font-bold mb-6">Discovery</h4>
                        <ul className="space-y-4 text-sm text-white/50">
                            ...
                            <li><a href="#" className="hover:text-brand-accent transition-colors">For Businesses</a></li>
                        </ul>
                    </div>
                ...
                <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-white/30 font-medium">
                    <p>© 2026 Maiyom. Proudly built in Coimbatore.</p>
