      ...
      <PageShell>
        ...
        <div className="px-5 pt-6 pb-4 glass-panel sticky top-0 z-20 mb-4 rounded-b-3xl">
          ...
          <motion.button
            ...
            className="w-full py-4 rounded-2xl bg-gradient-primary text-primary-foreground font-display font-semibold text-base flex items-center justify-center gap-2 shadow-glow animate-pulse-glow glow-on-hover clay-btn"
          >
